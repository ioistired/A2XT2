...
local imageFolderPath = Misc.resolveDirectory("emote")
local imageFiles = Misc.listFiles(imageFolderPath)
local images = {}
images.blank = Graphics.loadImage (Misc.resolveFile("emote\\blank.png"))	
...
for __,value in pairs (imageFiles) do
	...
	if  key ~= "blank"  then
		...
		images[key] = Graphics.loadImage (Misc.resolveFile("emote\\"..value))
